...
import { initDexto, postInitDexto } from './cli/commands/init.js';
import { getUserInputToInitDextoApp } from './cli/commands/init.js';
...
program
    ...
    .action(async (prompt: string[] = []) => {
        ...
        try {
            ...
            console.log(`🚀 Initializing Dexto with config: ${configPath}`);
